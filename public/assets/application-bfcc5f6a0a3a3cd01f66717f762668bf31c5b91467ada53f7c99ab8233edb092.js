...
$(document).ready(function(){
	...
	$('#file').styler({
		...
		fileBrowse : '<img src="/images/attach.png" />'
	});	
	...
	$('.quickorder .submit').click(function(e){
		e.preventDefault();
		$('body').append('<div class="thank-popup modal in"><div class="modal-dialog"><div class="modal-content"><button class="close" type="button"><img alt="" src="images/close.png"></button><div class="modal-body center-block thank">' + thankmsg + '</div></div></div></div>');
...
$(document).ready(function() {
    ...
    carousel.owlCarousel({
        ...
        pagination: false,
        navigationText: [
            '<img class="icon-chevron-left" src="/assets/left-5b52916d64b1da4c8900118c1ffafaae029c9a3ed1e4d5ed2fcfa01678590052.png" alt="Left 5b52916d64b1da4c8900118c1ffafaae029c9a3ed1e4d5ed2fcfa01678590052" />',
            '<img class="icon-chevron-right" src="/assets/right-61a9eb49a41426eaa323c824d572f2520ad1154e81a3fb06be48985e7fdddbd0.png" alt="Right 61a9eb49a41426eaa323c824d572f2520ad1154e81a3fb06be48985e7fdddbd0" />'
        ],
        items: 1,
    });
});
...
(function() {
  $(function() {
    return $(document).on('change', '.speciality_select', function(evt) {
      return $.ajax('/users/update_specialities', {
        type: 'GET',
        dataType: 'script',
        data: {
